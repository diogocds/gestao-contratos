                ...
                <ul class="nav side-menu">
                  ...
                  <li>
                    <a>
                      ...
                      Parceiros <span class="fa fa-chevron-down"></span>
                    </a>
                    <ul class="nav child_menu">
                      <li><a href="/admin/parceiros/criar">Criar Parceiros</a></li>
                      <li><a href="/admin/parceiros/listar">Listar Parceiros</a></li>
                    </ul>
                  </li>
