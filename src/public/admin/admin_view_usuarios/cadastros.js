...
document.getElementById('cep').addEventListener('input', function () {
    ...
    if (cep.length === 8) { // Se o CEP tiver 8 dígitos, faz a consulta
...
//     var ususario = document.getElementById('ususario').checked;
//     var locatario = document.getElementById('locatario').checked;

//     document.getElementById('camposUsuario').style.display = ususario ? 'block' : 'none';
//     document.getElementById('camposLocatario').style.display = locatario ? 'block' : 'none';
// }
